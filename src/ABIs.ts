...
export const aave: Record<`${aaveABIs}ABI`, ABI> = {
  ...
  dataProviderABI: [
    { constant: true, inputs: [], name: "getAllReservesTokens", outputs: [{ name: "", type: "tuple[]", components: [{ name: "symbol", type: "string" }, { name: "tokenAddress", type: "address" }] }], type: "function" },
